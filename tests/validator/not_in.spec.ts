...
describe('not_in validation rule', () => {
  it('should fail the value is in the set of comma separated values', () => {
  ...
  it('should fail when the numeric value is in the set of comma separated values', () => {
