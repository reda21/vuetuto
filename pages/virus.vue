...
import type { Topology } from "topojson"; // ou "topojson-client" selon votre installation // Assurez-vous que ce type correspond à votre installation
