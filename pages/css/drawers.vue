<template>
  ...
  <div class="card flex justify-center gap-2 mt-3">
    ...
    <Drawer v-model:visible="visible2" header="Drawer" position="full">
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        consequat.</p>
    </Drawer>
    <Button icon="pi pi-window-maximize" @click="visible2 = true" />
    <Drawer v-model:visible="visible3">
      <template #header>
        <div class="p-avatar flex items-center gap-2">
          <img src="https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png" data-pc-section="image"
            alt="Photo de profil de Amy Elsner" />
        </div>
      </template>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna
    ...
    <Button icon="pi pi-plus" @click="visible3 = true" />
    <Drawer v-model:visible="visible4">
    ...
    <Button icon="pi pi-bars" @click="visible4 = true" />
  </div>
</template>
