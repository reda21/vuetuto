<template>
  <div>
    <component :is="componentType" :class="buttonClasses" v-bind="componentAttrs"  @click="onClick" @change="onChange">
      <svg v-if="lazy" aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin"
...
const componentAttrs = computed(() => {
  if (props.as === "a") {
    ...
    return { type: props.type, value: props.label, disabled: props.disabled || props.lazy };
  } else {
